...
void __fastcall TForm1::Button3Click(TObject *Sender)
{
 ...
 StringGrid1->Cells[3][0]="тяга";
 StringGrid1->Cells[4][0]="плотность воздуха";
 StringGrid1->Cells[5][0]="расстояние пройденное по x";
...
{
  //нахождение плотности воздуха
  float ro0=2.3769*0.001;
  ro=ro0*exp(((-1)*z0)/(2.36*10000));
  //нахождение силы тяги
